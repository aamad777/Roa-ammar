...
if "child_name" not in st.session_state:
    st.session_state.child_name = "Nadeen or Yazan"
...
# Streamlit UI
# -----------------------
st.set_page_config(page_title="Ask Audai W Gofran", page_icon="👨‍👧‍👦", layout="centered")
st.title("👨‍👧 Ask Audai W Gofran")
...
if st.session_state.response_text and option in ["💬 Just answer", "💡 Do both"]:
    st.success(f"💬 Audai & Gofran says: {st.session_state.response_text}")
